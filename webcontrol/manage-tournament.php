    ...
    <div id="main-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Manage Game Tournament </li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="container " style="margin: 20px 0 !important;">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <button type="button" class="btn btn-primary style3 " style="float:right;" data-toggle="modal" data-target="#add">Add Tournament</button>
                        </div>
                    </div>
                        ...
                        <div class="card-header">
                            ...
                            <table class="table table-hover">
                                            ...
                                            <?php 
                                                ...
                                                $sqls=$conn->query("SELECT * FROM `dtournament`  ORDER BY dcategory");
                                                $total_records =$sqls->num_rows;
                                                $total_no_of_pages = ceil($total_records / $total_records_per_page);
                                                $start_from = ($page_no - 1) * $total_records_per_page;
                                                $c = $conn->query("SELECT * FROM `dtournament` ORDER BY dcategory ASC LIMIT $start_from, $total_records_per_page");
        ...
        <div class="modal-dialog" role="document" style="max-width:550px;">
            <div class="modal-content">
                <form action="manage-tournament-process" method="post">
                    <div class="modal-header">
                        <h3 class="modal-title" id="addressModalLabel">Create Tournament</h3>
                    ...
                    <div class="modal-body">
                                ...
                                <label for="catx">Category</label>
                                    <select name="category" required id="catx" class="form-control">
                                        ...
                                        <?php
                                        $boos = $conn->query("SELECT * FROM dgame_categories");
                                        if($boos->num_rows>0){
                            ...
                            <div class="form-group">
                                <label for="cat">Tournament</label>
                                <input type="text" name="tour" id="cat" required placeholder="Enter Tournament" class="form-control">
                            </div>
...
<?php
    ...
    $x = $conn->query("SELECT * FROM `dtournament` ORDER BY dcategory");
    if($x->num_rows>0):
    ...
    <div class="modal fade" id="max<?php echo $xx['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="addressModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document" style="max-width:550px;">
            <div class="modal-content">
                <form action="manage-tournament-process" method="post">
                    <div class="modal-header">
                        <h3 class="modal-title" id="addressModalLabel">Update Tournament</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div><!-- End .modal-header -->
                    <div class="modal-body">
                    <input type="hidden" name="hid"  value="<?php echo $xx['tid']; ?>">
                                ...
                                <label for="catx">Category</label>
                                    <select name="category" required id="catx" class="form-control">
                                        ...
                                        if($boos->num_rows>0){
                                            while($boox=$boos->fetch_assoc()){
                                        ?>
                                        <option <?php if($boox['category_id']==$xx['dcategory_id']) echo "selected" ?> value="<?php echo $boox['category_id']; ?>"><?php echo $boox['dcategory']; ?></option>
                                        <?php } } ?>
                            ...
                            <div class="form-group">
                                <label for="cat">Tournament</label>
                                <input type="text" name="tour" value="<?php echo $xx['dtour']; ?>" id="cat" required placeholder="Enter Tournament" class="form-control">
                            </div>
