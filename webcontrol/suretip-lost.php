                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">All Sure Tips Lost </li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card-header">
                            ...
                            <table class="table table-hover">
                                            ...
                                            <tbody id="myDIV">
                                            <?php 
                                                $sqls=$conn->query("SELECT * FROM `dgame` WHERE dresult='lost' AND tipcategory='Sure' ORDER BY id");
                                                $total_records =$sqls->num_rows;
                                                $total_no_of_pages = ceil($total_records / $total_records_per_page);
                                                $start_from = ($page_no - 1) * $total_records_per_page;
                                                $c = $conn->query("SELECT * FROM `dgame` WHERE dresult='lost' AND tipcategory='Sure' ORDER BY id DESC LIMIT $start_from, $total_records_per_page");
