                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">All Pending Daily Tips  </li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card-header">
                            ...
                            <table class="table table-hover">
                                            ...
                                            <tbody id="myDIV">
                                            <?php 
                                                $sqls=$conn->query("SELECT * FROM `dgame` WHERE dresult='pending' AND tipcategory='Daily' ORDER BY id");
                                                $total_records =$sqls->num_rows;
                                                $total_no_of_pages = ceil($total_records / $total_records_per_page);
                                                $start_from = ($page_no - 1) * $total_records_per_page;
                                                $c = $conn->query("SELECT * FROM `dgame` WHERE dresult='pending' AND tipcategory='Daily' ORDER BY id DESC LIMIT $start_from, $total_records_per_page");
...
$x = $conn->query("SELECT * FROM `dgame` WHERE dresult='pending' AND tipcategory='Daily' ORDER BY id DESC LIMIT $start_from, $total_records_per_page");
        ...
        <div class="modal-content">
            <form action="scores-process" method="post">
                ...
                <div class="modal-body">
                       ...
                       <input type="hidden" name="category" value="sure">
                <div class="row">
                        
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="cats"><?php echo $xx['dhome']; ?></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="catx"><?php echo $xx['daway']; ?></label>
